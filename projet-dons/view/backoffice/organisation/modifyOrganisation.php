...
<head>
    <meta charset="UTF-8">
    <title>Modifier l'Organisation</title>
    <style>
...
<body>
    <div class="container">
        <h1>✏️ Modifier l'Organisation #<?= $organisationData['id'] ?></h1>
        ...
        <form method="POST" id="orgForm">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" required 
                          ...
                          maxlength="500"><?= htmlspecialchars($organisationData['description'] ?? '') ?></textarea>
