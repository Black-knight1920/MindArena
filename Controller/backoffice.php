...
$reclamationsResult = $recCtrl->listReclamation();
$reclamations = $reclamationsResult;
...
foreach ($reclamations as $reclamation) {
    $nbReponses = $repCtrl->countReponsesByReclamationId($reclamation['id']);
    if ($nbReponses == 0) {
  ...
  <div class="backoffice-container">
    ...
    <nav class="backoffice-sidebar" id="sidebar">
      ...
      <div class="sidebar-nav">
        ...
        <div class="nav-section">Gestion des Réclamations</div>
        
        <div class="nav-item">
          <a href="view/backoffice/reclamation/reclamationList.php" class="nav-link">
            <span class="nav-icon">📋</span>
            Liste des réclamations
          </a>
        </div>
        <div class="nav-item">
          <a href="view/backoffice/reclamation/addReclamation.php" class="nav-link">
            <span class="nav-icon">➕</span>
      ...
      <main class="content-wrapper">
        ...
        <div class="dashboard-grid">
          ...
          <div class="stat-card">
            ...
            <a href="#" class="btn btn-primary">Voir tous les dons</a>
          </div>
          ...
          <div class="stat-card">
            ...
            <a href="#" class="btn btn-primary">Gérer les organisations</a>
          </div>
          ...
          <div class="stat-card">
            ...
            <div class="stat-description">
              Total des réclamations reçues
            </div>
            <a href="view/backoffice/reclamation/reclamationList.php" class="btn btn-primary">Gérer les réclamations</a>
          </div>

          <!-- Carte Réclamations Non Répondues -->
          <div class="stat-card">
            <span class="stat-icon">⚠️</span>
            <div class="stat-value"><?= $reclamationsNonRepondues ?></div>
            <div class="stat-title">Non Répondues</div>
            <div class="stat-description">
              Réclamations en attente de réponse
            </div>
            <a href="view/backoffice/reclamation/reclamationList.php" class="btn btn-primary">Voir les réclamations</a>
          </div>
        </div>
        ...
        <section class="quick-actions">
          ...
          <div class="actions-grid">
            ...
            <div class="action-card">
              ...
              <a href="#" class="btn btn-primary">Nouveau Don</a>
            </div>
            ...
            <div class="action-card">
              ...
              <a href="#" class="btn btn-primary">Nouvelle Organisation</a>
            </div>
            ...
            <div class="action-card">
              ...
              <a href="#" class="btn btn-secondary">Visiter le Site</a>
            </div>

            <!-- Action Gérer Réclamations -->
            <div class="action-card">
              <span class="action-icon">📋</span>
              <div class="action-title">Gérer les Réclamations</div>
              <div class="action-description">
                Consulter et répondre aux réclamations des utilisateurs
              </div>
              <a href="view/backoffice/reclamation/reclamationList.php" class="btn btn-primary">Voir les réclamations</a>
            </div>
          </div>
