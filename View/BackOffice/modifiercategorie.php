...
// Variables pour stocker les erreurs et les données
$errors = [];
$success_message = '';
...
$id = $_GET['id'] ?? null;
if (!$id) {
    header("Location: admin.php?section=categories&error=ID de catégorie manquant");
    exit();
}

// Récupérer les données actuelles de la catégorie
$categorie = $categorieController->getCategorieById($id);
if (!$categorie) {
    header("Location: admin.php?section=categories&error=Catégorie non trouvée");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $result = $categorieController->updateCategorie($id, $nom, $description);
        ...
        if ($result) {
            ...
            $errors['general'] = "Erreur lors de la modification de la catégorie dans la base de données";
        }
    }
    
    // Si erreurs, renvoyer les erreurs en JSON
    ...
    <main class="admin-main">
      ...
      <header class="admin-header">
        <div class="header-left">
          <div>
            <div class="header-left-title">Modifier une Catégorie</div>
      ...
      <div class="admin-content">
        <div class="content-inner">
          <div id="message-container">
            <!-- Les messages s'afficheront ici via JavaScript -->
          </div>
          ...
          <div class="card-shell">
            ...
            <form id="edit-category-form" method="POST" class="form">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div id="error-nom" class="error hidden"></div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="form-label" for="description">Description:</label>
                    <textarea class="form-control" id="description" name="description" rows="4" placeholder="Décrivez cette catégorie (au moins 10 caractères)..."><?= htmlspecialchars($categorie['description']) ?></textarea>
                    <div id="error-description" class="error hidden"></div>
                  </div>
                </div>
              </div>
  ...
  <script>
    ...
    document.getElementById('edit-category-form').addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            // Cacher toutes les erreurs précédentes
            ...
            if (data.success) {
                ...
                if (data.errors) {
                    ...
                    if (data.errors.general) {
                        messageContainer.innerHTML = `<div class="alert alert-danger">${data.errors.general}</div>`;
                    }
                }
            }
        })
