...
if (isset($_GET['id'])) {
    ...
    // CORRECTION : Utiliser getCategorieById() au lieu de getCategorie()
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm'])) {
    if ($categorieController->deleteCategorie($id)) {
        header("Location: admin.php?section=categories&success=Catégorie supprimée avec succès");
    } else {
        header("Location: admin.php?section=categories&error=Erreur lors de la suppression de la catégorie");
    }
    exit();
}
?>
    ...
    <main class="admin-main">
      ...
      <header class="admin-header">
        <div class="header-left">
          <div>
            <div class="header-left-title">Supprimer une Catégorie</div>
          ...
          <div class="card-shell">
            ...
            <div class="confirmation-box">
              ...
              <div class="item-info">
                ...
                <?php if (isset($categorie['date_creation'])): ?>
                  <p><strong>Date de création :</strong> <?= $categorie['date_creation'] ?></p>
                <?php endif; ?>
                <?php if (isset($categorie['date_ajout'])): ?>
                  <p><strong>Date d'ajout :</strong> <?= $categorie['date_ajout'] ?></p>
                <?php endif; ?>
              </div>

              <div class="warning-message">
                <h3><i class="ti ti-alert-triangle"></i> Attention</h3>
                <p>Vous êtes sur le point de supprimer cette catégorie définitivement.</p>
                <p><strong>Attention :</strong> Si des jeux sont associés à cette catégorie, ils deviendront orphelins.</p>
