    ...
    <style>
        ...
        * {
        ...
        .forum-card::before {
            ...
            opacity:0;
            background:
                radial-gradient(circle at top left,rgba(255,77,240,0.3),transparent 60%),
        ...
        .btn-report {
            background:linear-gradient(135deg, var(--ma-accent), #ffb84d);
            color:#2b163b;
...
<section class="page-header">
    <h1>Forums</h1>
    <p>Structure et espaces de discussion de la communauté MindArena.</p>
</section>
...
<div class="forums-wrapper">
    <div class="forum-toolbar">
        ...
        <a href="<?= $BASE ?>/index.php?action=add-forum" class="btn-neon">
            + Nouveau forum
        </a>
    </div>
                ...
                <div class="forum-card"
                    ...
                    <div class="forum-actions">
                        ...
                        <a class="btn-small btn-delete"
                           href="<?= $BASE ?>/index.php?action=delete-forum&id=<?= (int)$f['id'] ?>"
