...
<div class="form-container">
    <div class="form-card">
        <div class="warning-box">
            ...
            <h2>Attention !</h2>
            <p>Vous êtes sur le point de supprimer cette publication.</p>
        ...
        <div class="publication-info">
            ...
            <p><strong>Auteur :</strong> <?= htmlspecialchars($publication['author'] ?? 'Inconnu') ?></p>
        ...
        <form method="post" action="index.php?action=delete-publication&id=<?= (int)$publication['id'] ?>&forum_id=<?= (int)$forum['id'] ?>">
            <div class="form-group">
                ...
                <input
                    ...
                    id="creator_name"
                    name="creator_name"
                    placeholder="Nom exact de l'auteur"
                    required
                    autofocus
                >
                <div style="font-size: 0.85rem; color: #c7c7ff; opacity: 0.7; margin-top: 6px;">
                    Vous devez entrer exactement : <strong><?= htmlspecialchars($publication['author'] ?? 'Inconnu') ?></strong>
                </div>
            </div>
