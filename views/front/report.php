    ...
    <style>
        ...
        * {
        ...
        .target-preview {
            ...
            border:2px solid rgba(255,202,95,0.3);
            margin-bottom:24px;
            position: relative;
            z-index: 1;
        }
        ...
        .form-select:focus, .form-control:focus {
            ...
            box-shadow: 0 0 25px rgba(255,202,95,0.5),
        ...
        .btn-primary-ma {
            ...
            font-size: 0.9rem;
            color: #2b163b;
            box-shadow: 0 0 20px rgba(255,202,95,0.6),
                        0 4px 15px rgba(255,202,95,0.3),
        ...
        .btn-primary-ma:hover {
            ...
            box-shadow: 0 0 30px rgba(255,202,95,0.9),
                        0 8px 25px rgba(255,202,95,0.4);
        }
        ...
        <form method="post" id="reportForm" novalidate>
            ...
            <div class="mb-3">
                ...
                <textarea name="details" id="details" rows="4" class="form-control"
                          maxlength="1000" placeholder="Explique brièvement le problème…"></textarea>
            </div>
