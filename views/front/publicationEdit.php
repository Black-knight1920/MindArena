...
// Édition d'une publication par son auteur

$forum = $forum ?? null;
$publication = $publication ?? null;
$errors = $errors ?? [];
$old = $old ?? ['author' => '', 'content' => ''];

if (!$forum || !$publication) {
    die("<h2 style='color:white;text-align:center;margin-top:50px'>❌ Publication introuvable</h2>");
}
...
<head>
    <meta charset="UTF-8">
    <title>Modifier la publication - MindArena</title>
...
<div class="page-header">
    ...
    <p>Mets à jour le contenu de ta publication</p>
</div>
...
<div class="form-container">
    <div class="form-card">
        ...
        <div class="security-note">
            ...
            <p>Pour modifier cette publication, tu dois confirmer que tu es bien l'auteur en entrant ton nom exact : <strong><?= htmlspecialchars($publication['author']) ?></strong></p>
        </div>

        <form method="post">
            <input type="hidden" name="forum_id" value="<?= (int)$forum['id'] ?>">

            <!-- Nom de l'auteur pour vérification -->
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    id="author"
                    name="author"
                    value="<?= htmlspecialchars($old['author'] ?: $publication['author']) ?>"
                    maxlength="50"
                    required
                >
                <div class="hint">Entre 3 et 50 caractères</div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    maxlength="5000"
                    required
                ><?= htmlspecialchars($old['content'] ?: $publication['content']) ?></textarea>
                <div class="hint">Entre 5 et 5000 caractères</div>
            </div>

            <div class="form-actions">
                <a href="<?= $BASE ?>/index.php?action=publications&forum_id=<?= (int)$forum['id'] ?>" class="btn btn-secondary">
