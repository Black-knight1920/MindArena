...
<style>
    ...
    .form-card {
        border-radius: 20px;
        background: linear-gradient(135deg, rgba(0,208,255,0.18), rgba(15,15,30,0.96)),
                    var(--card-bg);
    ...
    body.light .form-card {
        background: linear-gradient(135deg, rgba(0,208,255,0.08), rgba(255,255,255,0.97)),
                    var(--card-bg);
    ...
    <div class="form-card">
        ...
        <form action="admin.php?action=publication-edit&id=<?= (int)$publication['id'] ?>" method="post" id="pubEditForm" novalidate>
            ...
            <div class="mb-3">
                ...
                <select name="forum_id" id="forum_id" class="form-select" required>
                    <?php foreach ($forums as $f): ?>
                        <option value="<?= (int)$f['id'] ?>"
                            <?= ($f['id'] == $publication['forum_id']) ? 'selected' : '' ?>>
                ...
                <div class="invalid-feedback" id="forumError"></div>
            </div>
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    id="author"
                    class="form-control"
                    value="<?= htmlspecialchars($publication['author']) ?>"
                >
                <div class="field-hint mt-1">
                    Maximum 40 caractères. Laissez vide pour anonymiser.
                </div>
            ...
            <div class="mb-2">
                ...
                <textarea
                    ...
                    class="form-control"
                    required
                ><?= htmlspecialchars($publication['content']) ?></textarea>
                <div class="field-hint mt-1">
